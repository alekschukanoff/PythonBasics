...
# Задача 15. Комбинированная задача Напишите программу: создайте список чисел, выведите только чётные числа, 
# а если встретите число больше 50 — остановите цикл. Подсказка: используйте for, if, break.
...
ls = [3,18,5,9,0,-12,10,6,24,50,28,80,7,11,10]
for el in ls:
  if el >= 50:
    break
  if el % 2 == 0:
